...
namespace EF_CONFIG.Extends
{
    public static class KnifeCaptureExport
    {
        ...
        private static string GetCurrentEditingFilePath(string StorageFolder, DateTime ExportDateOfWeek)
        {
            try
            {
                string knife_capture_path = $"{StorageFolder}/__KNIFE_CAPTURE__";
                ...
                DateTime FirstDate = SysExtends.FirstDayOfWeek(ExportDateOfWeek);
